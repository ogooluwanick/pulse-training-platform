...
export default function LandingPage() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#f5f4ed" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge variant="secondary" className="bg-parchment text-charcoal border-warm-gray/20">
                ...
                <p className="text-xl text-warm-gray leading-relaxed max-w-lg">
                  Transform your organization's learning culture with our intelligent corporate training platform. Build
                  skills, track progress, and drive real business outcomes.
                </p>
              </div>
      ...
      {/* Features Section */}
      <section id="features" className="py-20" style={{ backgroundColor: "rgba(245, 244, 237, 0.5)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-charcoal">Everything you need to scale learning</h2>
            <p className="text-xl text-warm-gray max-w-2xl mx-auto">
              From individual skill development to enterprise-wide training programs, Pulse adapts to your
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-alabaster border-warm-gray/20 shadow-soft hover:shadow-soft-lg transition-soft">
              <CardContent className="p-6 space-y-4">
                ...
                <h3 className="text-xl font-semibold text-charcoal">Multi-Tenant Architecture</h3>
                <p className="text-warm-gray">
                  Secure, scalable platform supporting multiple organizations with role-based access control.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-alabaster border-warm-gray/20 shadow-soft hover:shadow-soft-lg transition-soft">
              <CardContent className="p-6 space-y-4">
                ...
                <h3 className="text-xl font-semibold text-charcoal">Advanced Analytics</h3>
                <p className="text-warm-gray">
                  Deep insights into learning progress, engagement metrics, and business impact.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-alabaster border-warm-gray/20 shadow-soft hover:shadow-soft-lg transition-soft">
              <CardContent className="p-6 space-y-4">
                ...
                <h3 className="text-xl font-semibold text-charcoal">Certification Management</h3>
                <p className="text-warm-gray">
                  Automated certification tracking, renewal reminders, and compliance reporting.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            <h2 className="text-2xl font-semibold text-charcoal">Trusted by leading organizations worldwide</h2>
      ...
      <section className="py-20 bg-charcoal">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <h2 className="text-3xl lg:text-4xl font-bold text-alabaster">Ready to transform your learning culture?</h2>
          <p className="text-xl text-alabaster/80 max-w-2xl mx-auto">
            Join hundreds of organizations already using Pulse to build stronger, more capable teams through intelligent
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-warm-gray">The intelligent workspace for corporate training and development.</p>
            </div>
            <div>
