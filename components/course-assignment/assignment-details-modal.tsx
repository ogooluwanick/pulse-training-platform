...
export default function AssignmentDetailsModal({
  ...
  const completedLessons =
    assignment.lessonProgress?.filter((lp) => lp.status === 'completed')
      .length || 0;
                          ...
                          {quizResult && (
                            <div className="mt-2 p-2 bg-background rounded-md">
                              <div className="text-sm">
                                ...
                                <span
                                  className={`${quizResult.passed ? 'text-success-green' : 'text-red-500'}`}
                                >
                                  {quizResult.score}%{' '}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-1 text-sm text-warm-gray mb-2">
                          <HelpCircle className="h-3 w-3" />
                          <span>
                            {assignment.course.finalQuiz.questions.length}{' '}
                            questions
                          </span>
                        </div>
                        ...
                        {assignment.finalQuizResult && (
                          <div className="mt-2 p-2 bg-background rounded-md">
                            <div className="text-sm">
                              ...
                              <span
                                className={`${assignment.finalQuizResult.passed ? 'text-success-green' : 'text-red-500'}`}
                              >
